...
//                )
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(Arrays.asList("http://127.0.0.1:5500","http://localhost:3000", "http://70.12.247.36:3000", "https://i9a506.p.ssafy.io:4443")); // 특정 출처 지정
