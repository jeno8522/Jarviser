...
public class MeetingTest {
    ...
    void testMeetingInsertByMeetingId() throws Exception{
        ...
        //when 미팅 생성
        String encryptedMeetingId = ms.createMeeting(id,"wooseokMeeting");
        long meetingId = Long.parseLong(aesutil.decrypt(encryptedMeetingId));

        //then

        //미팅룸 찾기
        Meeting findMeeting = ms.findMeetingById(meetingId);
        //호스트 찾기
        User findHost = us.findUserById(id);

        //미팅 이름 확인
        Assertions.assertThat(findMeeting.getMeetingName()).isEqualTo("wooseokMeeting");
        //호스트 이름 확인
        Assertions.assertThat(findHost.getName()).isEqualTo("host");
...
//        //미팅 생성
//        //wooseok 미팅1 개설
//        String wooseokMeetingEncrypted = ms.createMeeting(wooseokId, "wooseokMeeting");
//        long wooseokMeetingId = Long.parseLong(aesutil.decrypt(wooseokMeetingEncrypted));
//        Meeting wooseokMeeting = ms.findMeetingById(wooseokMeetingId);
//
//        //minwoo 미팅2 개설
